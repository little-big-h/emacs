(custom-set-variables
 ...
 '(safe-local-variable-values (quote ((magit-git-executable . "/home/holger/bin/git"))))
 '(standard-indent 2)
...
(global-unset-key "")
(eval-after-load "cc-mode" (lambda nil "" () (define-key c-mode-base-map "" 'compile) (define-key c-mode-base-map (kbd "C-/") 'comment-or-uncomment-region)))
